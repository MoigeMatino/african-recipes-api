...
def upgrade() -> None:
    ...
    op.create_foreign_key("creator_foreign_key", 'recipes', 'user', ['user_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.add_column('recipes',
                  sa.Column('ingredients', postgresql.ARRAY(sa.VARCHAR()), autoincrement=False, nullable=False))
    op.add_column('recipes',
    ...
    op.drop_constraint('creator_foreign_key', 'recipes', type_='foreignkey')
